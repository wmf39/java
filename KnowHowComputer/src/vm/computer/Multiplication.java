...
public class Multiplication implements Software {
	...
	public HashMap<Integer, Triple<Command, Integer, Integer>> getProgram() {
		...
		program.put(1, new Triple<>(Command.JMP, null, 5));			// Start checking if R1 empty
		...
		program.put(6, new Triple<>(Command.JMP, null, 2));			// No
		// Multiply
		...
		program.put(11, new Triple<>(Command.JMP, null, 7));		// No
		...
		program.put(22, new Triple<>(Command.JMP, null, 19));		// No
		// End
