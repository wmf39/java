...
public class MPv2Lasttest {
	...
	public static void main(String[] args) throws InterruptedException {
		MPv2Lasttest st = new MPv2Lasttest();
		st.communicate();
	}
	public void communicate() throws InterruptedException {
		...
		if(rs485usb != null) {
			...
			try {
				...
				byte [] telegram = {STX,ADR,FN,GET,LEN,D1,crcHigh,crcLow};
				long start = System.nanoTime();
				int trys = 201, ok = 0, failed = 0;
